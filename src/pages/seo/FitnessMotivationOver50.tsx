              ...
              <Card className="border-2 border-primary shadow-xl overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-3">
                    {["Free - 3 goals, 7-day streaks, daily check-ins", "Pro ($3.99/mo) - Unlimited goals, Streak Repair, 30-day history", "Premium ($7.99/mo) - AI Coach, unlimited history, data export"].map((line) => (
