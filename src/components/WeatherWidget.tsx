    ...
    try {
      ...
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          if (temp >= 90) {
            condition = "Hot";
            recommendation = "It's very hot - consider indoor activities or an early morning routine";
          } else if (temp >= 80) {
            condition = "Warm";
            recommendation = "Warm weather - stay hydrated during outdoor activities";
          } else if (temp <= 32) {
            condition = "Cold";
            recommendation = "It's cold - warm up before heading outside";
          ...
          if (aqi > 100) {
            airQuality = "poor";
            recommendation = "Poor air quality - indoor activities recommended";
          } else if (aqi > 50) {
            airQuality = "moderate";
